      ...
      <header className="absolute inset-x-0 top-0 z-50">
          ...
          <div className="flex lg:flex-1 text-white">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img
                ...
                className="h-20 rounded-sm w-auto"
              />
            </a>
            <a 
               className="-bloc text-white rounded-lg py-5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                    >
                      Catastrophic Restaurant
                    </a>
                    {/* <FontAwesomeIcon icon="fa-thin fa-dark fa-user-chef" /> */}
          </div>
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <a href="#" className="-m-1.5 p-1.5">
              {/* <span className="sr-only">Catastrophic Restaurant</span> */}
              <img
                alt=""
                src="https://st4.depositphotos.com/33942896/40632/v/450/depositphotos_406326112-stock-illustration-restaurant-simple-logo-design-vector.jpg"
      ...
      {/* <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <ListItem className="p-0 ">
          <label
            ...
            className="flex w-full cursor-pointer items-center px-2 py-5"
          >
